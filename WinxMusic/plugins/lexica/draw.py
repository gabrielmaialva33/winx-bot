...
@app.on_message(
    filters.command(["draw", "create", "imagine", "dream", "desenhe", "art"]) & filters.group & ~BANNED_USERS)
...
async def select_model(_: Client, query: t.CallbackQuery):
    ...
    if prompt_data is None:
        return await query.edit_message_text("🔴<b> algo deu errado, tente novamente mais tarde</b>")
    ...
    images[-1] = t.InputMediaDocument(img_url[-1],
