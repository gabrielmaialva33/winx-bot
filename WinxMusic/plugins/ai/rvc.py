    ...
    try:
        ...
        if not reply.voice:
            ...
            if reply.voice.duration > 15:
                return await message.reply_text("𝗔𝘂𝗱𝗶𝗼 𝗺𝘂𝗶𝘁𝗼 𝗹𝗼𝗻𝗴𝗼. 𝗠𝗮𝘅𝗶𝗺𝗼 𝟭𝟱 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀.")
            ...
            # download the audio
            await bot.download_media(message=reply.voice, file_name=f"./downloads/{reply.voice.file_unique_id}.ogg")
            ...
            if os.path.exists(file_path):
                ...
                return await message.reply_audio(audio=file_path,
                                                 title="Lule 🌈",
                                                 caption="𝗔𝘂𝗱𝗶𝗼 𝗲𝗱𝗶𝘁𝗮𝗱𝗼 𝗽𝗼𝗿 Winx 🌈")
            else:
