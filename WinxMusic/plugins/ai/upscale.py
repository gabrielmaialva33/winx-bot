...
async def upscale(_, message):
    ...
    if file is None:
        return await message.reply_text("💬 ➜ responda a uma mensagem com uma 🖼️ para 🔍 aumentar a escala ⬆️.")
    ...
    try:
        ...
        with open(upscaled, "rb") as upscaled_file:
            await message.reply_document(upscaled_file, caption=f" ➜ 🖼 imagem ampliada por 👤 @{app.me.username} ✅")
